...
交互应用启动后，初始界面首先呈现标题Logo与初始场景的叠加场景，此时旅人站在石台上，系统会屏蔽所有输入。检测到参展者人脸进入画面以后，MediaPipe客户端会向Unity端发送开始信号，进入开场动画：画面缓缓放大，摄像机穿越层层迷雾进入三维场景——其间迷雾中浮现出蓝色波形图案。摄像机持续前推，最终从云雾中显现出旅人在绵延山峦与旷野前行的画面。摄像机逐渐减速，最终停在旅人斜前方，平视旅人，留出背后辽阔的风景，画面叠加第一章名称“初域·未定之原”。这一序幕以电影化的镜头语言为参展者建立了初步的情感锚点与叙事期待。
